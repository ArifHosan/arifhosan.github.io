...
var API_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].restApi;
...
var API_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].judgeApi;
var RunnerService = /** @class */ (function () {
    function RunnerService(http) {
        this.http = http;
        this.params = { "base64_encoded": "false" };
    }
    RunnerService.prototype.submitCode = function (data) {
        return this.http.post(API_URL + "submissions", data, { params: this.params });
    };
    RunnerService.prototype.getSubmission = function (token) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(languageService, runnerService) {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.languageService.getAllLanguage().subscribe(function (res) {
            _this.languageList = res;
        });
    };
    HomeComponent.prototype.ngAfterViewInit = function () {
    };
    HomeComponent.prototype.changeCodeLanguage = function (event) {
        this.currentLanguage = this.languageList.filter(function (x) { return x._id == event.value; })[0];
        var name = this.currentLanguage.file_name;
        var detectedMode = CodeMirror.findModeByFileName(name + ".js");
    ...
    HomeComponent.prototype.onRun = function () {
        var _this = this;
        ...
        this.runnerService.submitCode(data).subscribe(function (token) {
            console.log(token);
            setTimeout(function () {
                _this.getSubmissionInfo(token["token"]);
            }, 1000);
        });
    };
    HomeComponent.prototype.getSubmissionInfo = function (token) {
        var _this = this;
        this.statusProperties.status.class = "text-info";
        this.statusProperties.status.text = "Running.....";
        this.runnerService.getSubmission(token).subscribe(function (res) {
            console.log(res);
            _this.processResponse(res);
        });
    };
    HomeComponent.prototype.processResponse = function (result) {
        var _this = this;
        if (result.status.id <= 2) {
            setTimeout(function () {
                _this.getSubmissionInfo(result.token);
            }, 1000);
            return;
        }
        this.isRunning = false;
